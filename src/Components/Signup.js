            ...
            <div className="user-screen-item screen-form">
               <div className="user-form">
                     <div className="nft-input-box validate-input" data-validate="Name is required">
                        ...
                        <input className="nft-input"  type="text" placeholder="Max" value={this.state.username} onChange={this.handleusername}></input>
                     ...
                     <div className="nft-input-box validate-input" data-validate="Name is required">
                        ...
                        <input className="nft-input" type={this.state.hidden ? 'password' : 'text'} placeholder="*****" value={this.state.password} onChange={this.handlepassword}></input>
                        <span className="focus-nft-input"></span>
                     </div>
                     <div className="nft-input-box validate-input" data-validate="Name is required">
                        <span className="label-nft-input"> Confirm Password</span>
                        <input className="nft-input" type={this.state.hidden ? 'password' : 'text'} placeholder="*****" value={this.state.confirmPass} onChange={this.handleconfirmpass}></input>
                        <span className="focus-nft-input"></span>
                     </div>
